	...
	<body>
		<div class="container">
			...
			while($row_produtos = mysqli_fetch_assoc($resultado_produto)){
				...
				echo "<a href='edit_produto.php?id=" . $row_produtos['produto_id'] . "'><i class='fas fa-edit'></i>Editar</a><br>";
				echo "<a href='proc_apagar_produto.php?id=" . $row_produtos['produto_id'] . "' data-confirm='Tem certeza de que deseja excluir o item selecionado?'><i class='fas fa-trash-alt'></i>Apagar</a><br><hr>";
			}

...
<div class="carrinho" id="navbar">
	...
	if($id_cat==3){
	echo '<marquee loop="-1" scrollamount="15"><h3><img src="img/iconeokl2.png" width="25" height="25" >Variedades de óculos<img src="img/iconeokl2.png" width="25" height="25" ></h3></marquee>';
	}else{
	echo'<marquee loop="-1" scrollamount="15"><h3><img src="img/iconeokl2.png" width="25" height="25" >Variedades de camisetas<img src="img/iconeokl2.png" width="25" height="25" ></h3></marquee>';
	}
	?>
<div id="barraLateral">
...
<img id="imgocu" src="img/oculosazul.jpg" width="194" height="80" >
	...
	<?php
		...
		$read_produto=mysqli_query($connect,"SELECT * FROM produtos WHERE produto_id != '' {$sql_categoria} ORDER BY nome ASC");
		...
		<div id="ca1">
             ...
             <img src="imgbdo/<?php echo $read_produto_view['imagem'];?>">
            
                <h6 >
                  
                </h6>
				<a href="produto.php?id=<?php echo $read_produto_view['produto_id'];?>"><h5>
				<img src="img/carrinho.png"></a></h5>
	
				<h6>R$ <?php echo number_format($read_produto_view['preco'],2,",",".");?></h6>
				
               <h4>Adicionar</br>ao carrinho</h4>
	...
	<script type="text/javascript" src="js/bootstrap.min.js"></script>
		...
		<a href="index.php?cat=<?php echo $read_categoria_view['categoria_id'];?>"><i class="fas fa-arrow-up"></i>Voltar ao topo</font></a>
		<?php
					}
				}
			}

...
<div class="carrinho" id="navbar">
	...
	<marquee loop="-1" scrollamount="15"><h3><img src="img/iconeokl2.png" width="25" height="25" >Meus pedidos<img src="img/iconeokl2.png" width="25" height="25" ></h3></marquee>
	<div id="barraLateral">
...
<img id="imgocu" src="img/oculosazul.jpg" width="194" height="80" >
		...
		<?php
			...
			$read_pedido=mysqli_query($connect,"SELECT * FROM pedido ORDER BY pedido_data DESC");
			if(mysqli_num_rows($read_pedido) > '0'){
				foreach ($read_pedido as $read_pedido_view){
					...
					if($status_pedido == 'Processando'){
						echo '<td><a href="pagar.php?id='.$read_pedido_view['pedido_id'].'">Pagar</a></td>';
					}
	...
	<script type="text/javascript" src="js/bootstrap.min.js"></script>
		...
		<p class="float-right" >
				<a href="meus-pedidos.php"><i class="fas fa-arrow-up"></i>Voltar ao topo</font></a>
		</p>

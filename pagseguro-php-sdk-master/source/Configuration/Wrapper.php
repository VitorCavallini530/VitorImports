...
{
    const ENV = "sandbox";
    const EMAIL = "vitorsiqueira530@gmail.com";
    const TOKEN_PRODUCTION = "your_production_token";
    const TOKEN_SANDBOX = "0C5DC341AA0446C0B3B80DE7734ECC36";
    const APP_ID_PRODUCTION = "your_production_application_id";
    const APP_ID_SANDBOX = "app7022528773";
    const APP_KEY_PRODUCTION = "your_production_application_key";
    const APP_KEY_SANDBOX = "3687D8F3CACAB52334379FA5A7AAE98E";
    const CHARSET = "UTF-8";
